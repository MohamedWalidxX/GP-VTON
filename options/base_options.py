...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/kaggle/working/checkpoints', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str,default='/kaggle/input/gp-vton-dataset/VITON-HD/VITON-HD/train')
        ...
        self.parser.add_argument('--/kaggle/input/gp-vton-dataset/VITON-HD/VITON-HD/train_pairs_1018.txt', type=str, default='train_pair.txt')
